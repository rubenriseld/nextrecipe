export const countryArray = [
    ...
    {id: 'american', value: ['United States', 'Canada']},
    {id: 'nordic', value: ['Denmark', 'Norway', 'Sweden', 'Finland', 'Iceland', 'Faraoe Islands', 'Greenland', 'Åland', 'Aland Islands']},
